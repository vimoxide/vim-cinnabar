...
function! spaceline#colorscheme#space#space()
  ...
  call spaceline#colors#spaceline_hl('GitInfo',s:slc,  'black',  'yellow')
  call spaceline#colors#spaceline_hl('GitAdd',s:slc,  'black',  'green')
  call spaceline#colors#spaceline_hl('GitRemove',s:slc,  'black',  'red')
  call spaceline#colors#spaceline_hl('GitModified',s:slc,  'black',  'blue')
